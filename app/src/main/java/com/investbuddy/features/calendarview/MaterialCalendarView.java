...
import com.investbuddy.features.calendarview.format.ArrayWeekDayFormatter;
import com.investbuddy.features.calendarview.format.DayFormatter;
import com.investbuddy.features.calendarview.format.MonthArrayTitleFormatter;
import com.investbuddy.features.calendarview.format.TitleFormatter;
import com.investbuddy.features.calendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
  ...
  OnDateLongClickListener onDayClickListener;
  ...
  public MaterialCalendarView(Context context, AttributeSet attrs) {
    ...
    try {
      int calendarModeIndex = a.getInteger(
          com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_calendarMode,
          0
      );
      int firstDayOfWeekInt = a.getInteger(
          com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_firstDayOfWeek,
          -1
      );

      titleChanger.setOrientation(
          a.getInteger(
              com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_titleAnimationOrientation,
              VERTICAL
          ));
      ...
      showWeekDays = a.getBoolean(com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_showWeekDays, true);
      ...
      setSelectionMode(a.getInteger(
          com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_selectionMode,
          SELECTION_MODE_SINGLE
      ));

      final int tileSize = a.getLayoutDimension(
          com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_tileSize,
...
//              com.prolificinteractive.materialcalendarview.R.drawable.mcv_action_previous
//          )
//      );
//      setRightArrow(
//          a.getResourceId(
//              com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_rightArrow,
//              com.prolificinteractive.materialcalendarview.R.drawable.mcv_action_next
//          )
//      );
      ...
      CharSequence[] array = a.getTextArray(com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_weekDayLabels);
      if (array != null) {
        setWeekDayFormatter(new ArrayWeekDayFormatter(array));
      }

      array = a.getTextArray(com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_monthLabels);
      if (array != null) {
...
//          com.prolificinteractive.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_Header
//      ));
      ...
      setDateTextAppearance(a.getResourceId(
          ...
          com.prolificinteractive.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_Date
      ));
      ...
      setAllowClickDaysOutsideCurrentMonth(a.getBoolean(
          com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_allowClickDaysOutsideCurrentMonth,
          true
      ));
    } catch (Exception e) {
      e.printStackTrace();
  ...
  private void setupChildren() {
    ...
    pager.setId(com.prolificinteractive.materialcalendarview.R.id.mcv_pager);
  ...
  public CharSequence getCalendarContentDescription() {
    return calendarContentDescription != null
           ...
           : getContext().getString(com.prolificinteractive.materialcalendarview.R.string.calendar);
  }
...
//    setDateSelected(day, true);
  ...
  /**
   * Get the current {@link com.prolificinteractive.materialcalendarview.CalendarMode} set of the Calendar.
   *
  ...
  public void setOnDateClickListener(OnDateLongClickListener longClickListener) {
    this.onDayClickListener = longClickListener;
  }
